...
function generatePassword() {
  ...
  var number = prompt(
    "Choose a length of your password - enter a number of at least 8 and no more than 128"
  );
  ...
  if (!lowerCase && !upperCase && !numeric && !special) {
    ...
    character = lowercaseLetter.concat(
      uppercaseLetter,
      numericValue,
      specialCharacter
    );
  ...
  // print password on page
  document.getElementById("print-pw").innerHTML =
